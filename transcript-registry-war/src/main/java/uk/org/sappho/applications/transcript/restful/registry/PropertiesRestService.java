...
public class PropertiesRestService {
    ...
    public SortedMap<String, Object> getProperties() throws TranscriptException {
    ...
    public void setProperties(SortedMap<String, Object> properties) throws TranscriptException {
